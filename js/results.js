...
// ─── 2. ICT H5 before/after IQR comparison bar chart ────────────────────────

const ictCtx = document.getElementById("ict-chart").getContext("2d");

new Chart(ictCtx, {
  type: "bar",
  data: {
    labels: ["With all data (n=29)", "After IQR removal (n=28)"],
    datasets: [
      {
        label: "Spearman ρ",
        data: [0.731, 0.781],
        backgroundColor: [COLOR_HIGH, COLOR_HIGH],
        borderWidth: 0,
        borderRadius: 2,
        yAxisID: "y",
      },
      {
        label: "R²",
        data: [0.614, 0.447],
        backgroundColor: [COLOR_MID, COLOR_MID],
        borderWidth: 0,
        borderRadius: 2,
        yAxisID: "y",
      }
